...
| `workflow-audit` | `/workflow-audit` | 5-layer UI workflow audit with 20 issue categories, 12 automated checks, regression canaries, targeted flow tracing, and diff mode |
